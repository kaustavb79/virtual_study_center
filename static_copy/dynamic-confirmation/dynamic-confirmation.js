...
//  set "data.position" with appropriate "screen position number" if position in configuration is "not a number" means it is a string
    ...
    if(data.show_close_btn=="true"){
         dcc_close_btn = `<button class="dcc-close-btn" tabindex=0>&times;</button>`;
    }
    ...
    var confirmation_container = `<div class="dynamic-confirmation-container" id="dcc">
                                    <div class="dcc-wrapper">
                                        <div class="dcc-content" id="dcc-content">
                                            ...
                                            <div class="dcc-body-container">
                                                <div class="dcc-body-div" id="dccb">
    ...
    var dcc_content = $(".dcc-content");

    // apply effect to confirmation overlay
    switch(data.effect){
        case "no":
            $(".dynamic-confirmation-container").show();
        break;

        case "fade":
            $(".dynamic-confirmation-container").fadeIn(300);
        break;
    ...
    var dcc_btn= $(".dynamic-confirmation-container button, .dynamic-confirmation-container input:not(:hidden), .dynamic-confirmation-container textarea, .dynamic-confirmation-container select");
...
function dcc_close(){
    $(".dynamic-confirmation-container").remove();
