...
class AllNotificationsList(NotificationViewList):
    ...
    def get_queryset(self):
        if settings.get_config()['SOFT_DELETE']:
            ...
            qset = Notification.objects.filter(recipient=self.request.user, notification_type='Notification').all()
...
class UnreadNotificationsList(NotificationViewList):
    ...
    def get_queryset(self):
        qset_unread = Notification.objects.filter(recipient=self.request.user, notification_type='Notification').unread()
        return qset_unread
